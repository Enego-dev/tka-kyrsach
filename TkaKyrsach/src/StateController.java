...
public class StateController {
    ...
    private static boolean[] Vi = new boolean[3];  // Открыть задвижку резервуаров
    ...
    private static boolean[] DRi = new boolean[3]; // Опустошен ли резервуар Ri
    private static boolean[] DVi = new boolean[3]; // Открыт ли резервуар Ri
    private static boolean[] DPi = new boolean[4]; // Находится ли контейнер под резервуаром Ri или он в P0
    ...
    private static boolean[] Dj = new boolean[8];  // Заполнен ли бункер Dj
    ...
    // движение контейнера в 0-100, где 10 - P0, 20 - P1, 30 - P2, 40 - P3
